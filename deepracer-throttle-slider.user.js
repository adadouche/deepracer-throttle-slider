...
(function() {
    ...
    const setCarThrottle = function (throttle) {
        return window.axios.put('/api/max_nav_throttle', { throttle: parseInt(throttle) });
    };
    ...
    const addSliderDOM = function(element) {
    ...
    const observerFunc = function(mutations, observer) {
